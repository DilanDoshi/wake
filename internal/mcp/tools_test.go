...
func (f spyFleet) SetTeam(ctx context.Context, id, team string) error {
	return f.fleet.SetTeam(ctx, id, team)
}
func (f spyFleet) SetColor(ctx context.Context, id, color string) error {
	return f.fleet.SetColor(ctx, id, color)
}
...
const notInTheStatusReportCount = 11
