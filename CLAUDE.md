...
- **Small files: 200–400 typical, 800 hard max.** The two largest non-test files are
  `internal/daemon/spawn.go` at 799 and `internal/ui/slash.go` at 799 — that sentence is derived by
