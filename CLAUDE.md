...
- **A dynamic `Workflow()` run is `task_type:"local_workflow"`, reusing the five `task_*` subtypes**
  ...
  pause, resume or restart. `docs/superpowers/notes/2026-09-23-workflow-findings.md` §1–3, §6.
