...
- **Small files: 200–400 typical, 800 hard max.** The two largest non-test files are
  `internal/rpc/wire.go` at 798 and `internal/ui/dm.go` at 798 — that sentence is derived by
